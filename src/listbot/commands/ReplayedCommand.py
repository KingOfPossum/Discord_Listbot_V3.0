...
class ReplayedCommand(Command):
    ...
    @staticmethod
    async def change_replayed_status(game_name: str, ctx: discord.Interaction = None, interaction: discord.Interaction = None) -> GameEntry | None:
        """
    ...
    async def execute(self,ctx):
        ...
        new_game_entry = await self.change_replayed_status(game_name=game_name,ctx=ctx)
